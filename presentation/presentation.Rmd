...
# Is there a  relationship between geographical and societal qualities in countries all over the world? 

# (liner or logistic) Regression analysis

```{r regression, echo = FALSE}
infant_mortality_vs_GDP <- lm(GDP ~ deathrate + infant_mortality, data = Countries_of_the_world)
